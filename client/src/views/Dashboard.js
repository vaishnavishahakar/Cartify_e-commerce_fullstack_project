...
function Dashboard() {
  ...
  return (
    <div>
      <h1 className="text-center py-6 text-3xl font-extrabold text-gray-800">
        Dashboard
      </h1>
      ...
      <div className="bg-white w-[500px] mx-auto px-8 py-6 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 mt-10">
        ...
        <div className="flex justify-around mb-6">
          <Link
            to="/user/orders"
            className="text-center text-md bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition"
          >
        ...
        <div className="flex flex-col gap-4">
          <UserDetailRow
            icon={<NameIcon className="text-blue-500" />}
            value={user?.name}
          />
          <UserDetailRow
          ...
          />
          <UserDetailRow
            icon={<RoleIcon className="text-blue-500" />}
            value={user?.role}
          />
        </div>
